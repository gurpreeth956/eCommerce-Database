...
def checkout():
    ...
    return render_template('checkout.html', employee=employee, loggedin=loggedinname, items=items, quantity=quantity, total=total,
...
def address():
    global employee
    return render_template('address.html', employee=employee, loggedin=loggedinname, title='Address', styles='wishlist.css',
                           bodyclass='bg-light')
